...
- [x] 页面布局
  - [x] 更新 `app/script/[id]/dialogue/page.tsx`
  - [x] 使用扁平化背景
  - [x] 优化容器布局
- [x] 顶部信息栏
  - [x] 使用扁平化卡片
...
- [x] 输入区域
  ...
  - [x] 添加快捷键提示
- [x] 僵局对话框
  - [x] 集成 DeadlockDialog 组件
  - [x] 处理用户选择

#### 5.8 分析报告页重构 🔴 P0 ✅

- [x] 页面布局
  - [x] 更新 `app/script/[id]/report/page.tsx`
  - [x] 使用扁平化背景
  - [x] 添加 Confetti 动画
- [x] 英雄类型卡片
  - [x] 集成 HeroTypeBadge 组件
  - [x] 使用扁平化卡片设计
  - [x] 添加缩放动画
- [x] 三维分析卡片
  - [x] 集成 DimensionChart 组件
  - [x] 使用扁平化进度条
  - [x] 添加动画效果
- [x] 关键时刻卡片
  - [x] 使用扁平化卡片
